package com.pcassem.www.huaweithyj.view;
...
public class BottomBar extends View {
    ...
    private int titleColorBefore = Color.parseColor("#A4A5A8");
    private int titleColorAfter = Color.parseColor("#4590E9");

    private int titleSizeInDp = 12;
    private int iconWidth = 26;
    private int iconHeight = 26;
    private int titleIconMargin = 2;
