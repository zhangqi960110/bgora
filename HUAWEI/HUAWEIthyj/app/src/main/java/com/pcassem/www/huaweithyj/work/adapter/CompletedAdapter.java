...
public class CompletedAdapter extends RecyclerView.Adapter<CompletedAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public CompletedAdapter(Context context, List<ServiceEntity.ListDataBean> data) {
        this.mContext = context;
        this.mData = data;
    }

    public void setmData(List<ServiceEntity.ListDataBean> data) {
        this.mData = data;
    ...
    @Override
    public void onBindViewHolder(@NonNull CompletedAdapter.ViewHolder holder, final int position) {
    ...
    public void setmOnItemClickListener(CompletedAdapter.OnItemClickListener mOnItemClickListener) {
        this.mOnItemClickListener = mOnItemClickListener;
    }

    private CompletedAdapter.OnItemClickListener mOnItemClickListener = null;
